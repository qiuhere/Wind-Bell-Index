...
Third, you should check the code in TestingAPI, and set the path of Neo4j and the database yourself. You should also choose the dataset you use, and modify the reading of dataset in the code.(The dataset we use is too large for github, we will put it on onedrive:??) 
